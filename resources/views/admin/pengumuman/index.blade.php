                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <form action="{{ route('admin.pengumuman.destroy', $pengumuman->id) }}" method="POST" onsubmit="return confirm('Yakin ingin hapus pengumuman ini?');">
                                @csrf
                                @method('DELETE')
                        ...
                        <h6 class="card-subtitle mb-2 text-muted">
                            <i class="bi bi-person-fill"></i> {{ $pengumuman->user->name }} | 
                            <i class="bi bi-clock-fill"></i> {{ $pengumuman->created_at->format('d M Y, H:i') }} |
                            <i class="bi bi-tag-fill"></i> {{ $pengumuman->devisi->nama_devisi ?? 'Semua Devisi' }}
                        </h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="devisi_id" class="form-select">
                            <option value="">-- Untuk Semua Devisi --</option>
